...
import EModelCollectionDetails from '../../components/ResourceDetails/EModelCollection';
...
const EModelCollectionDetailsContainer: React.FunctionComponent<{
  ...
  const emodels = sortBy(mapEmodelCollQueryResults(data), 'name');
  const emodelCollection = { ...props.resource, ...{ emodels } };
